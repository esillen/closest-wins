...
class StartupDataInitializer(
	...
	fun initializePlayers() {
		// Create 5 players
		val players = listOf(
			PlayerData("Alice", "🎯", "#FF6B6B", 40.7128, -74.0060), // New York
			PlayerData("Bob", "🚀", "#4ECDC4", 51.5074, -0.1278),   // London
			PlayerData("Charlie", "🌟", "#FFE66D", 35.6762, 139.6503), // Tokyo
			PlayerData("Diana", "🎨", "#A8E6CF", null, null),      // No guess
			PlayerData("Eve", "⚡", "#FF8B94", null, null)          // No guess
		)
